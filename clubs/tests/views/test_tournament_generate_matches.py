...
class GenerateMatchesTournamentTestCase(TestCase):
    """Tests of the generate_matches functionalities"""
    ...
    def test_generate_matches_tournament(self):
        self.tournament.date = make_aware(datetime(2020, 1, 1, 0, 0, 0))
        ...
        url = reverse('generate_matches', kwargs={'tournament_id': self.tournament.id})
    ...
    def test_generate_matches_tournament_with_next(self):
        ...
        url = reverse_with_query('generate_matches', {'tournament_id': self.tournament.id}, {'next': next_url})
        response = self.client.get(url)
    ...
    def test_generate_matches_tournament_incorrect_stage(self):
